...
@RestController
@RequestMapping(value = "/api/midtrans",  produces = MediaType.APPLICATION_JSON_VALUE)
public class MidtransController {
  private static final Logger log = LoggerFactory.getLogger(MidtransController.class);
  private final RestClient restClient;
  private final MidtransConfig midtransConfig;
  private final MidtransService service;

  public MidtransController(MidtransConfig midtransConfig, MidtransService service) {
